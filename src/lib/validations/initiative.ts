...
export const tagSchema = z.object({
  type: z.enum(["bu", "site", "function", "customer_tier", "product_family", "custom"]),
...
export const driverValueSchema = z.object({
  ...
  notes: z.string().max(2000).optional(),
  source: z.enum(["MANUAL", "IMPORTED", "REQUESTED", "CALCULATED", "BASELINE"]).optional(),
});
...
export const createScenarioSchema = z.object({
  ...
  overrides: z.record(z.string(), z.union([
    z.number(),
    z.string(),
    z.boolean(),
    z.array(z.number()),
