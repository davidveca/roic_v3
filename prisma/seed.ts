...
const templates = [
  {
    ...
    description:
      "Model savings from freight rate negotiations, mode optimization, carrier consolidation, or network redesign.",
    category: "cost",
    iconName: "Truck",
    requiredDrivers: [
      "baseline_revenue",
  ...
  },
  {
    ...
    description:
      "Model revenue impact from pricing actions, product mix shifts, or value-based selling initiatives.",
    category: "revenue",
    iconName: "TrendingUp",
    requiredDrivers: [
      "baseline_revenue",
  ...
  },
  {
    ...
    description:
      "Model cash flow impact from DSO, DIO, or DPO improvements through process or policy changes.",
    category: "working_capital",
    iconName: "Wallet",
    requiredDrivers: ["baseline_revenue", "baseline_cogs", "effective_tax_rate"],
    optionalDrivers: [
    ...
    scenarioKnobs: ["dso_improvement_days", "dio_improvement_days"],
    sortOrder: 3,
  },
  {
  ...
  },
  {
    ...
    description:
      "Model savings from vendor rationalization, contract renegotiation, or procurement optimization.",
    category: "cost",
    iconName: "Building",
    requiredDrivers: [
      "baseline_cogs",
...
async function main() {
  ...
  console.log("Only @wahlclipper.com email addresses are allowed.");
  console.log("\nTo sign in:");
  console.log("1. Go to /login");
  console.log("2. Enter your Wahl email address");
